...
In the [previous post](https://byteski.net/blog/article/typescript-what-is-all-about-and-why-should-you-use-it) we talked about what is [[TypeScript]] and why should we use that. Now it's time to go to practice.
...
> An example of this code is written with [[Node]]. If Node is not installed on your machine, check out the post about [How To Install or Update Node by Using nvm (Node Version Manager)](https://byteski.net/blog/article/how-to-install-or-update-node-by-using-nvm).
...
It means that [[TypeScript]] was successfully installed on our machine. What is **tsc** command? It is a **TypeScript compiler**. As mentioned in the [previous post](https://byteski.net/blog/article/how-to-install-or-update-node-by-using-nvm), TypeScript compiler is a tool, or program, that turns the TypeScript code into JavaScript code. We need this feature because we will execute this compiled JavaScript code by [[Node]].

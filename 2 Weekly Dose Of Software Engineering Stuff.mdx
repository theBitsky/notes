...
- Last week I published new post [How To Configure tsconfig.json: TypeScript Strict options](https://byteski.net/blog/article/how-to-configure-tsconfigjson-typescript-strict-options)

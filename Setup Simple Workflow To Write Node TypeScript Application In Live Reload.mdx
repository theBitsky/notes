...
I'm sure you already installed [[Node]] on your computer but maybe you need to update your version. If so, check out the post about [How To Install or Update Node by Using nvm (Node Version Manager)](https://byteski.net/blog/article/how-to-install-or-update-node-by-using-nvm).
